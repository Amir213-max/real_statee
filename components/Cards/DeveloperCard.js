        ...
        <div className="flex items-start space-x-4 rtl:space-x-reverse">
          <div className="relative w-20 h-20 flex-shrink-0">
            {isGoogleDriveUrl(developer.logo) ? (
              <GoogleDriveImage
                src={developer.logo || 'https://drive.google.com/uc?export=view&id=1DC79hQjquKI53xWewYXLI6UosblZWF6j'}
              ...
              <Image
                src={convertGoogleDriveUrl(developer.logo) || 'https://drive.google.com/uc?export=view&id=1DC79hQjquKI53xWewYXLI6UosblZWF6j'}
                alt={t({ ar: developer.name_ar, en: developer.name_en })}
                fill
                className="object-contain rounded-lg"
                unoptimized
