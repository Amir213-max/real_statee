...
export default function Map({ latitude, longitude, address }) {
  // Using a placeholder map
  // In production, you would use Mapbox or Google Maps
  // Example: const mapUrl = `https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/pin-s+ff0000(${longitude},${latitude})/${longitude},${latitude},12,0/800x400?access_token=YOUR_TOKEN`;
